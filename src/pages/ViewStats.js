...
function ViewStats() {
  ...
  const fetchPayments = async () => {
    try {
      const cashRes = await axios.get('http://3.226.219.194:5000/api/payments?method=cash');
      const onlineRes = await axios.get('http://3.226.219.194:5000/api/payments?method=online');
